 ...
 *         &lt;element name="pMEME_MEDCD_NO" type="{http://www.w3.org/2001/XMLSchema}string" minOccurs="0"/&gt;
...
@XmlRootElement(name = "ListClaim_v11_MemberKeyorMedicaidNumber")
public class ListClaimV11MemberKeyorMedicaidNumber {

    protected Config pConfig;
    @XmlElement(name = "pMEME_CK", required = true, type = Long.class, nillable = true)
    protected Long pmemeck;
    @XmlElement(name = "pMEME_MEDCD_NO")
    protected String pmememedcdno;
    ...
    /**
     * Gets the value of the pmememedcdno property.
     * 
     * @return
     *     possible object is
     *     {@link String }
     *     
     */
    public String getPMEMEMEDCDNO() {
        return pmememedcdno;
    }

    /**
     * Sets the value of the pmememedcdno property.
     * 
     * @param value
     *     allowed object is
     *     {@link String }
     *     
     */
    public void setPMEMEMEDCDNO(String value) {
        this.pmememedcdno = value;
    }
